...
-(void)creatSubviews{
    ...
    countryCodeTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 20, self.view.bounds.size.width, self.view.bounds.size.height-20 - BarBottomHeight) style:UITableViewStyleGrouped];
